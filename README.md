...
1. Clone the repository to your local machine:
   ```bash
   git clone https://github.com/vignesh232567/Fake-News-Detection-using-MachineLearning.git
   ```
...
**Author**
- VIGNESH M (https://github.com/vignesh232567)

- If you have any questions or need further assistance, feel free to contact us at  vigneshvignesh77541@gmail.com
